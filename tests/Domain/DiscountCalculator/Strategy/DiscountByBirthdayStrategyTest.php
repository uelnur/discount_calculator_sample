...
class DiscountByBirthdayStrategyTest extends TestCase {
    public function testBirthdayStrategy(): void {
        $tripStartDae = '2024-07-09';
        $result = $this->testStrategy('2006-07-09', $tripStartDae);
        $this->assertNull($result);

        $result = $this->testStrategy('2006-07-10', $tripStartDae);
        ...
        $result = $this->testStrategy('2012-07-10', $tripStartDae);
        $this->assertInstanceOf(Discount::class, $result);
